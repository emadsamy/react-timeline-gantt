...
export default class DataTask extends Component {
  ...
  render() {
    ...
    return (
      ...
      <div class="timeline-user mb-5">
        <div class="timeline-user-inner">
            <span class="arrow-top arrow-inner"><i class="fas fa-chevron-up"></i></span>
            <div class="userContent userCT">
                <div class="userImg"><img src="img/user.png" class="circle img-fluid" /></div>
                <div class="userInfo">
                    <div>
            ...
            <div class="userStatus userStatus-ongoing">
                <div class="userStatus-circle">
                    <span class="icon-options userStatus-ic"></span>
                </div>
                <div class="userStatus-text">Ongoing
                    <div class="status-tooltip"></div>
                </div>
            </div>
            <span class="arrow-bottom arrow-inner"><i class="fas fa-chevron-down"></i></span>
        </div>
      </div>
