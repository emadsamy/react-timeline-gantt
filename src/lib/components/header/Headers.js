...
export default class Header extends PureComponent {
  ...
  renderHeaderRows = (top, middle, bottom) => {
    ...
    return (
      <div className="timeLine-main-header-container" style={{ width: DATA_CONTAINER_WIDTH, maxWidth: DATA_CONTAINER_WIDTH, flex: "0 0 90px"}}>
        <div className="header-top" style={{ backgroundColor: "#FFF", color: "#4E4E4E" }}>
          {result.top}
        </div>
        <div className="header-middle" style={{ backgroundColor: "#FFF", color: "#000" }}>
          {result.middle}
        </div>
        <div className="header-bottom" style={{ backgroundColor: "#FFF", color: "#000" }}>
          {result.bottom}
        </div>
      </div>
    );
  ...
  render() {
    ...
    // }
    return (
      <div id="timeline-header" ref="Header" className="timeLine-main-header-viewPort" style={{flex: "0 0 90px"}}>
        {this.renderHeader()}
      </div>
    );
  }
